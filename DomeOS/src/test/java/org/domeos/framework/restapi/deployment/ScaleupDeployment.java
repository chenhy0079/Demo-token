...
private int deployCollectionId;
	...
	public void testScaleupDeploy(){
		...
		Response upodateDeploy = given()
				...
				.body("resultCode", equalTo(200))
				.when()
				.post("http://localhost:8080/restapi/deploy/action/scaleup?deployId="+deployId+"&version=1&replicas=2");
	 ...
	 */
	@Test
	public void testScaleupDeploy2(){

		Response scaleupDeploy = given()
				.header("Authorization",ClientUtil.Auth("testuser","admin"))
				.contentType("application/json;charset=UTF-8")
				.post("http://localhost:8080/restapi/deploy/action/scaleup?deployId="+0+"&version=1&replicas=2");
	 ...
	 */
	@Test
	public void testScaleupDeploy3(){

		Response scaleupDeploy = given()
				.header("Authorization",ClientUtil.Auth("testuser","admin"))
				.contentType("application/json;charset=UTF-8")
				.post("http://localhost:8080/restapi/deploy/action/scaleup?deployId="+deployId+"&version=1&replicas=-1");
