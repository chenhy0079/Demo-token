...
public class UpdateDeploy {
	...
	public void testUpdateDeploy(){
		...
		Response upodateDeploy = given()
				...
				.body("resultCode", equalTo(200))
				.when()
				.post("http://localhost:8080/restapi/deploy/action/update?deployId="+deployId+"&version=1&replicas=2");
	...
	public void testUpdateDeploy1(){
		...
		Response upodateDeploy = given()
				...
				.when()
				.post("http://localhost:8080/restapi/deploy/action/update?deployId="+0+"&version=1&replicas=1");
	...
	public void testUpdateDeploy2(){
		...
		Response upodateDeploy = given()
				...
				.body("resultCode", equalTo(400))
				.when()
				.post("http://localhost:8080/restapi/deploy/action/update?deployId="+deployId+"&version=0&replicas=1");
