...
function(e) {
  ...
  function(t) {
    ...
    c = function(e) {
      if (null !== e && !isNaN(e)) {
        var t = void 0;
        return e >= 0 && e < 1024 ? t = e.toFixed(2) + "MB": e >= 1024 && (t = (e / 1024).toFixed(2) + "GB"),
        t
      }
    },
    u = function(e, t) {
      for (var r = void 0,
      n = new RegExp("{#([a-zA-z0-9]+)}"); null !== (r = n.exec(e));) {
    ...
    f = function(e, t, r) {
      ...
      var i = t - e;
      return n.day = Math.floor(i / 864e5),
      i -= 24 * n.day * 3600 * 1e3,
      n.hours = Math.floor(i / 36e5),
      i -= 3600 * n.hours * 1e3,
      n.mimutes = Math.floor(i / 6e4),
      r && (i -= 60 * n.mimutes * 1e3, n.seconds = Math.floor(i / 1e3)),
      n
    };
    return {
      isEmptyObject: i,
      ...
      getPageInterval: function(e, t) {
        var r = "",
        n = void 0;
        return ! e || !t || t - e <= 0 ? r = "0秒": (n = f(e, t, !0), 0 !== n.day && (r += n.day + "天"), 0 !== n.hours && (r += n.hours + "小时"), 0 !== n.mimutes && (r += n.mimutes + "分钟"), 0 !== n.seconds && (r += n.seconds + "秒"), "" === r && (r = "0秒")),
        r
      },
      getDateInterval: f,
  ...
  }]).factory("$domeModel", ["$http",
  function(e) {
    var t = function(e) {
      for (var t = arguments.length,
      r = Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++) r[n - 1] = arguments[n];
      for (var i = e,
      o = [].concat(r), a = 0, l = o.length; a < l; a++) i += "/" + o[a];
      return i
    };
    return {
      SelectListModel: function() {
        function e(t) {
          ...
          this.selectListName = t ? t: "selectList",
          this.isCheckAll = !1,
          ...
          value: function(e, t) {
            ...
            this[this.selectListName] = function() {
              if (e && 0 !== e.length) {
                if ("[object Object]" === Object.prototype.toString.call(e[0])) {
                  ...
                  try {
                    for (var a, l = e[Symbol.iterator](); ! (n = (a = l.next()).done); n = !0) {
                      var c = a.value;
                      c.keyFilter = !0,
                      void 0 !== t && (c.isSelected = t),
                      c.isSelected && r.selectedCount++
                    }
                  } catch(e) {
                    i = !0,
                    o = e
                ...
                s = e.length; u < s; u++) e[u] = {
                  item: e[u],
                  keyFilter: !0,
                  isSelected: t
                },
                void 0 !== t && (e[u].isSelected = t),
                e[u].isSelected && r.selectedCount++;
                return r.selectedCount === e.length && (r.isCheckAll = !0),
                e
              }
              return []
            } ()
        ...
        },
        {
          key: "checkAllItem",
          value: function(e) {
            this.isCheckAll = void 0 === e ? this.isCheckAll: e,
            this.selectedCount = 0;
      ...
      instancesCreator: function(e) {
        ...
        function(t) {
          ...
          var o = void 0,
          a = e[t];
          return "function" == typeof a ? o = new(Function.prototype.bind.apply(a, [null].concat(n))) : (o = {},
...
"use strict"; !
function(e, n, t) {
  n.directive("selectCon", ["$document",
  function(e) {
    return {
      restrict: "AEC",
      scope: !0,
      ...
      link: function(n, t, i) {
        ...
        if (0 !== a.length) {
          ...
          var r = function(e) {
            c = void 0 !== e ? e: !c,
            c === !0 ? (l.show(), o.removeClass("fa-angle-right").addClass("fa-angle-down")) : c === !1 && (l.hide(), o.removeClass("fa-angle-down").addClass("fa-angle-right"))
          },
          d = function(e) {
            return r(!1),
            e.stopPropagation()
          ...
          var u = function n(t) {
            var i = t.target;
            0 === l.find(i).length && "select-list" != i.className && r(!1),
            e.off("click", n)
          };
          l.on("mouseenter",
          function() {
          ...
          function() {
            a.on("blur", d),
            "true" == i.multicheckbox && e.on("click", u)
          }),
          "INPUT" === a[0].tagName ? a.on("focus",
          function() {
            r(!0)
          }) : a.on("click",
          function() {
          ...
          "true" == i.label && (t.on("click",
          function() {
            a.focus()
          }), a.bind("focus",
          function(e) {
            a.width(t.width() - 20 - a.position().left),
            e.stopPropagation()
          }).bind("blur",
          function() {
            a.width(120)
  ...
  function(e) {
    return {
      ...
      link: function(n, t, i, l) {
        ...
        o = a.attr("ng-click");
        o ? o += ";hideSelect($event.stopPropagation());": o = "hideSelect($event.stopPropagation())",
        a.attr("ng-click", o),
        t.html(e(t.html())(n))
      }
    }
    ...
    return {
      ...
      link: function(e, n, t, i) {
        i.$parsers.unshift(function(n) {
          ...
          return i.$setValidity("notEqual", !t),
          n
        })
      }
    }
...
"use strict"; !
function(o) {
  o.constant("loginUrl", "/login/login.html"),
  o.constant("logoutUrl", "/api/user/logout"),
  o.constant("documentUrl", "http://gitbook.domeos.org/")
...
function _toConsumableArray(e) {
  if (Array.isArray(e)) {
    for (var n = 0,
    t = Array(e.length); n < e.length; n++) t[n] = e[n];
    return t
  }
  return Array.from(e)
}
...
function(e) {
  e.factory("api", ["$http", "$timeout", "$filter", "loginUrl",
  function(e, n, t, r) {
    var o = {},
    a = {};
    ...
    o.SimplePromise.all = function(e) {
      return new o.SimplePromise(function(n, t) {
        var r = [],
        o = 0;
        try { [].concat(_toConsumableArray(e)).forEach(function(a, i) {
            a.then(function(t) {
              r[i] = t,
              ++o === e.length && n(r)
            }).
    ...
    o.SimplePromise.race = function(e) {
      return new o.SimplePromise(function(n, t) {
        try { [].concat(_toConsumableArray(e)).forEach(function(e) {
            return e.then(n).
            catch(t)
          })
        } catch(e) {
    ...
    o.loadScript = function() {
      ...
      return function(t, r, o) {
        return e.hasOwnProperty(t) || (e[t] = n(t, r, o)),
        e[t]
      }
    } ();
    var i = function(n, t, r) {
      return function(i) {
        ...
        l = Array(c > 1 ? c - 1 : 0), u = 1; u < c; u++) l[u - 1] = arguments[u];
    ...
    o.memberCollection = function() {
      ...
      e.getTypes = c(l(["PROJECT_COLLECTION", "DEPLOY_COLLECTION", "CLUSTER", "CONFIGURATION_COLLECTION", "LOADBALANCER_COLLECTION"])),
      e.listByType = function(e) {
              ...
              e.containerConsoles = (e.containerConsoles || []).map(function(e) {
                return {
                  ...
                  volumeMountConsoles: e.volumeMountConsoles.map(function(e) {
                    return e.readonly = e.readonly.toString(),
                    e
                  }),
            ...
            return {
              ...
              configConsoles: function() {
                return (e.configConsoles || []).map(function(e) {
                  return e.name = e.configMap.name,
                  e.volumeConfigMap.configurationId = e.configMap.id,
                  e.volumeConfigMap.name = e.configMap.name,
                  e.volumeConfigMap.iterms = e.configMap.configFileList.reduce(function(e, n) {
                    return n.path && (e[n.name] = n.path),
                    e
                  },
                  {}),
                  e.configMap = void 0,
    ...
    o.overview = function() {
      ...
      var n = function(e, n, t) {
        ...
        if (r.hasOwnProperty(n) && o.hasOwnProperty(t)) return o[t].replace(/\$/,
        function() {
          return r[n].replace(/\$/,
          function() {
            return e
        ...
        return e.create = function(e) {
          return i("POST", "/api/loadBalancer")({
            ...
            serviceDraft: function() {
              var n = {};
              return "EXTERNAL_SERVICE" === e.type ? (n.lbPorts = e.serviceDraft.lbPorts, n.sessionAffinity = e.serviceDraft.sessionAffinity, n.deployId = e.serviceDraft.deployment.deployId, n.deployName = e.serviceDraft.deployment.deployName, n.deployStatus = e.serviceDraft.deployment.deployStatus) : n = null,
              n
            } (),
            nginxDraft: function() {
              var n = {};
        ...
        e.getById = function(e) {
          return i("GET", "/api/loadBalancer/id/" + e)().then(function(e) {
            return e.nginxDraft ? (e.nginxDraft.rules = (e.nginxDraft.rules || []).map(function(e) {
              ...
              e.volumeDraft = e.volumeDraft ? e.volumeDraft: {
                volumeType: "EMPTYDIR"
              },
              e
            ...
            e.serviceDraft.sessionAffinity = String(e.serviceDraft.sessionAffinity)),
            e
          })
        },
        e.delete = function(e) {
...
function(n) {
  ...
  n.directive("pageContentBox", ["$parse",
  function(n) {
    return {
      ...
      transclude: !0,
      link: function(t, e, o) {
        var a = function() { (t._$tabs || []).forEach(function(n) {
      ...
      function(n, t) {
        ...
        t._$currentPage = function() {
          ...
          return t._$loadedPages.indexOf(e.page) === -1 && t._$loadedPages.push(e.page),
          e
        },
  ...
  n.factory("dialog", ["api", "$compile", "$rootScope", "$controller", "$timeout", "userFriendlyMessage",
  function(n, t, e, o, a, i) {
    var l = {},
    r = 0;
    l.button = {
      BUTTON_OK: 1,
    ...
    l.secondaryButtons = [l.button.BUTTON_NO, l.button.BUTTON_ABORT, l.button.BUTTON_IGNORE, l.button.BUTTON_CANCEL],
    l.buttons = {
      BUTTON_EMPTY: 0,
    ...
    l.common = function(i) {
      ...
      "number" == typeof p ? B.css({
        ...
        width: p
      }) : B.addClass("dialog-box-with-auto"),
      O && B.addClass("dialog-warning");
      ...
      if (m) {
        ...
        R.on("click", w),
        angular.element(document).on("keyup", S),
        C = function() {
          R.off("click", w),
          angular.element(document).off("keyup", S)
        }
      }
      if (_) {
      ...
      return a(function() {
        y.removeClass("dialog-hidden"),
        a(function() { (y[0].querySelector("input[autofocuse]") || y[0].querySelector("input") || y[0]).focus()
        },
        200)
      }),
    ...
    l.alert = u(l.buttons.BUTTON_OK_ONLY),
    l.
    continue = u(l.buttons.BUTTON_OK_CANCEL),
    l.question = u(l.buttons.BUTTON_YES_NO),
    l.optquestion = u(l.buttons.BUTTON_YES_NO_CANCEL),
    l.retry = u(l.buttons.BUTTON_RETRY_CANCEL),
    l.no_one_need_this = u(l.buttons.BUTTON_ABORT_RETRY_IGNORE),
    l.error = u(l.buttons.BUTTON_OK_ONLY, {
      warning: !0
    }),
...
function(e) {
  ...
  t = function(e, n) {
    ...
    function(n) {
      ...
      l = Array(o > 1 ? o - 1 : 0), r = 1; r < o; r++) l[r - 1] = arguments[r];
      var i = e.call.apply(e, [this,
      function() {
        t.splice(a, 1),
  ...
  e.component("formContainer", {
    ...
    function(e) {
      var t = this;
      t.uniqueId = n(),
      t.defaultLeftWidth = 120,
      t.inputMaxWidth = 880,
      t.requireWidth = 28,
      e.$watch("$ctrl.leftColumnWidth",
      function() {
  ...
  e.component("formInputRadioGroup", {
    ...
    function(e, o) {
      ...
      a = function() {
        var e = i(l.ngModel);
        "invalid" !== e && "empty" !== e || u(),
        "custom" !== e && "fake" !== e && l.ngModel !== l.customValue || (l.customValue = l.ngModel, l.value = l.customFakeValue),
        "valid" === e && (l.value = l.ngModel)
      },
      c = function() {
        l.ngModel = l.value = null,
        l.customValue = "",
        p()
      },
      s = function(e) {
      ...
      a(),
      e.$watch("$ctrl.ngModel", a),
      e.$watch("$ctrl.value", d),
      e.$watch("$ctrl.options", m)
    }]
  }),
  ...
  e.component("formInputCheckbox", {
    ...
    function(e, o) {
      ...
      l.valid = !1,
      l.name || (l.name = n()),
      void 0 === l.valueTrue && (l.valueTrue = "on"),
      void 0 === l.valueFalse && (l.valueFalse = "");
      var i = function() {
        l.ngModel === l.valueTrue ? l.value = !0 : l.ngModel === l.valueFalse ? l.value = !1 : l.ngModel = l.value ? l.valueTrue: l.valueFalse
      },
      a = function() {
        "boolean" != typeof l.value && (l.value = 1 == l.value),
        l.ngModel !== l.valueTrue && l.value && (l.ngModel = l.valueTrue, r(function() {
          return l.onChange()
        },
        0)),
        l.ngModel === l.valueFalse || l.value || (l.ngModel = l.valueFalse, r(function() {
          return l.onChange()
        },
        0))
      },
      ...
      e.$watch("$ctrl.ngModel", i),
      e.$watch("$ctrl.value", a),
      e.$watch("$ctrl.valueTrue", a),
      e.$watch("$ctrl.valueFalse", a),
      e.$watch("$ctrl.value", c)
    }]
  }),
  ...
  e.component("formArrayContainer", {
    ...
    function(e) {
      ...
      t(),
      e.$watch("$ctrl.ngModel", t, !0),
      e.$watch("$ctrl.ngModel", o, !0),
      e.$watch("$ctrl.minLength", t),
      e.$watch("$ctrl.maxLength", t)
    }]
  }),
  e.component("formSearchDropdown", {
    ...
    function(e, o, r) {
      ...
      d(),
      e.$watch("$ctrl.showInput", d),
      e.$watch("$ctrl.showOptions", d),
      i.currentIndex = -1,
      i.currentOption = null;
      var m = function(e, n) {
        i.currentOption = e,
        i.currentIndex = n
      },
      ...
      $ = function() {
        i.submitOnBlur ? (p(i.searchText) || L(), p(i.searchText) ? f(i.currentOption) : "" === i.searchText ? h() : f(i.chosedOption)) : f(i.chosedOption),
        u = !1,
        d()
      },
      b = function() {
      ...
      C = function() {
        var e = i.searchText,
        n = i.searchDelay ? Number(i.searchDelay) : 200; (!n && 0 !== n || n < 0) && (n = 200),
        null !== e && a(function() {
      ...
      O = function() {
        ...
        angular.equals(e, i.filteredOptions) || (i.filteredOptions = angular.copy(e)),
        L()
      };
      e.$watch("$ctrl.searchText", O),
      e.$watch("$ctrl.options", O);
      var k = function() {
        ...
        if (t && t[0]) {
          ...
          a = r + n.height(),
          c = null;
          o < r ? c = o: l > a && (c = l - n.height()),
          null !== c && n.stop(!0, !0).animate({
            scrollTop: c
          },
          200)
      ...
      S = function(e, n) {
        ...
        i.ngModel === i.chosedOption ? o = i.chosedOption: t.some(function(e) {
  ...
  e.component("formSelect", {
    ...
    controller: ["$scope", "$timeout", "$document",
    function(e, o, r) {
      var i = this,
      a = t(o, e),
      c = l(e);
  ...
  e.component("formSelectWithBackend", {
    ...
    controller: ["$scope", "api", "$timeout", "$filter",
    function(e, n, t, o) {
      var l = this;
      l.candidateList = [];
      ...
      e.$watch("$ctrl.param", i, !0),
      e.$watch("$ctrl.backend", i),
      e.$watch("$ctrl.ngModel", l.input)
    }]
  }),
  e.component("formMultipleSelect", {
    ...
    function(e, o, r) {
      ...
      i.onValueChange = function(e) {
        ...
        t !== n.length - 1 && (null !== t && i.chosed.splice(t, 1), i.chosed.push(e)),
        a(u, 0),
        x()
      },
      ...
      p = function() {
        var e = !0;
        return i.chosed && i.chosed.length || (e = !1),
        null === i.aboutToDelete && (e = !1),
        (i.aboutToDelete < 0 || i.aboutToDelete >= i.chosed.length) && (e = !1),
        e && i.deleteChosedItem(i.chosed[i.aboutToDelete]),
        i.aboutToDelete = null,
        e
      },
      g = function() {
      ...
      f = function(e) {
        ...
        null === n && (n = i.chosed.length),
        n += e,
        n >= i.chosed.length && (i.aboutToDelete = null),
        i.aboutToDelete = n
      },
      h = function(e) {
        i.aboutToDelete = null
      ...
      y = function(e) {
        ...
        if (v(e)) {
          if (8 === e.keyCode && (m() ? (n = !0, p()) : $() && (n = !0, g())), 37 === e.keyCode || 39 === e.keyCode) {
            var t = 39 === e.keyCode ? 1 : -1; (b() || m()) && (n = !0, f(t))
          }
          46 === e.keyCode && m() && (n = !0, p())
        }
        n ? e.preventDefault() : m && (n = !0, h()),
        n && a(function() {})
      };
      r.on("click focusin focusout keydown", y),
      c(function() {
      ...
      w = function() {
        angular.isArray(i.ngModel) || (i.ngModel = []),
        angular.isArray(i.options) || (i.options = []),
        angular.isArray(i.chosed) || (i.chosed = []);
  ...
  e.component("formTable", {
    ...
    controller: [function() {
      ...
      e.cancelEdit = function(n) {
        ...
        angular.copy(e.editedData[n], e.ngModel[n]),
        delete e.editedData[n]
      },
  ...
  e.component("inputWithCopy", {
    ...
    function(e) {
      var t = this;
      t.id = n(),
      e.loadScript("/lib/js/clipboard.js/clipboard.min.js",
      function() {
        return window.Clipboard
      }).then(function() {
        var e = "#" + t.id + " button";
        new Clipboard(e).on("success",
        function(e) {
          e.clearSelection()
        })
      })
  ...
  e.component("codearea", {
    ...
    controller: ["api", "$scope", "$interval", "$timeout",
    function(e, t, l, r) {
      var i = this,
      a = o(l, t),
      c = o(r, t);
      ...
      m = 0,
      p = 0;
      e.loadScript("/lib/js/ace/ace.js",
      function() {
        return window.ace
      }).then(function() {
        u = ace.edit(i.editorId),
        u.getSession().setMode("ace/mode/" + (s[i.language] || "text")),
        u.on("input",
        function() {
          i.ngModel = d = u.getValue(),
          c(function() {
            i.onChange()
          })
        }),
        ...
        u.$blockScrolling = 1 / 0,
        u.setReadOnly( !! i.readonly),
        u.setOptions({
          minLines: m,
          maxLines: p
        })
      ...
      100),
      t.$watch("$ctrl.ngModel",
      function(e, n) {
        d !== e && (d = e, u && u.setValue(d, 1))
      }),
      t.$watch("$ctrl.readonly",
      function(e, n) {
        u && u.setReadOnly( !! i.readonly)
      }),
      t.$watch("$ctrl.language",
      function(e, n) {
      ...
      function(e, n) {
        ...
        t ? (m = parseInt(t[1], 0) || 0, p = "" === t[2] ? 1 / 0 : parseInt(t[2], 0) || 0) : m = p = 0,
        u && u.setOptions({
          minLines: m,
          maxLines: p
        })
  ...
  e.component("markdown", {
    ...
    function(e, n) {
      ...
      l = function() {
        ...
        var r = n.loadScript("/lib/js/showdown.min.js",
        function() {
        ...
        n.SimplePromise.all([l, r]).then(function(n) {
          ...
          if (e === o) {
            ...
            angular.element("a, area", c).attr("target", "_blank"),
            t.html = c.html()
          }
        })
      };
      e.$watchGroup(["$ctrl.source", "$ctrl.src"],
      function() {
        l()
      })
    }]
  ...
  e.component("chart", {
    ...
    function(e, t) {
      var o = this;
      o.id = n();
      var l = e.loadScript("/lib/js/Chart.min.js",
      function() {
        return window.Chart
      }),
      r = null,
      ...
      var a = function() {
        ...
        a = {
          ...
          Array.isArray(o.data) && o.data.length || (o.noData = !0),
          n = (o.data || []).map(function(e, n) {
      ...
      t.$watchGroup(["$ctrl.data", "$ctrl.labels", "$ctrl.color", "$ctrl.type"],
      function() {
        a()
      })
    }]
  ...
  e.component("lineChart", {
    ...
    controller: ["$scope", "$timeout", "chartHandler",
    function(e, t, o) {
      var l = this;
      l.id = n();
      var r = null,
  ...
  e.service("chartHandler", ["$timeout", "api",
  function(e, n) {
    var t = [],
    o = [],
    l = function(e, n) {
  ...
  e.component("memberCollectionSelect", {
    ...
    function(e, n) {
      ...
      i = function() {
        if (o.indexOf(t.type) !== -1 && !t.loadingTypes[t.type]) if (l[t.type]) r();
        else {
          var e = t.type;
          t.loadingTypes[e] = !0,
          t.options = [],
          t.ngModel = null,
          n.memberCollection.listByType(e).then(function(n) {
            t.loadingTypes[e] = !1,
            l[e] = n,
            r()
          })
  ...
  e.component("collectionMemberTable", {
    ...
    function(e, n, t) {
      ...
      var l = function() {
        return t.
        continue.apply(t, arguments).then(function(e) {
      ...
      a = function(e) {
        var t = null;
        return t = e ? "您将要把自己的权限降低为" + e + "，修改后您可能无法继续编辑成员信息或执行部分管理操作，确认要继续吗？": "您将要把自己从成员列表中删除，删除后您将不能继续访问相关资源，确认要继续吗？",
        n.SimplePromise.resolve(l("您的权限即将发生变化", t))
      },
      c = function(e) {
      ...
      o.addMember = function() {
        if (o.currentCollection) {
          ...
          if ("MEMBER" === o.addingType) {
            ...
            e = n.memberCollection.get(o.chosedGroup),
            "DEFAULT" !== o.addingGroupRole && (e = e.then(function(e) {
              return e.forEach(function(e) {
      ...
      o.updateUserRole = function(e) {
        o.loading = !0;
        var l = null;
        l = e.id === o.myInfo.id && i(e.role) > i(o.userRole) && !o.myInfo.isAdmin ? a(e.role) : n.SimplePromise.resolve(),
        l.then(function() {
      ...
      o.removeUser = function(e) {
        o.loading = !0;
        var l = null;
        l = e.id !== o.myInfo.id || o.myInfo.isAdmin ? c(e.name) : a(),
        l.then(function() {
      ...
      var s = function(e, n, t) {
        ...
        o.noEdit = [],
        o.noDelete = [],
        "MASTER" !== t && (o.noEdit = e.slice(0), o.noDelete = e.filter(function(e) {
          return e.id !== n.id
        }));
      ...
      p = function() {
        var e = void 0;
        o.collectionType && o.collectionId || (e = null),
        e = {
  ...
  e.component("formSelectorProjectImage", {
    ...
    function(e) {
      ...
      n.placeholder = "选择镜像",
      n.imageList = [],
      e.get("/api/image").then(function(e) {
        var t = e.data.result || [];
  ...
  e.component("clusterSelector", {
    ...
    controller: ["$scope", "api", "$timeout",
    function(e, n, o) {
      var l = this;
      l.isLoadingCluster = !0,
      n.cluster.listCluster().then(function(e) {
        var n = e || [];
    ...
    function(e, n, o) {
      ...
      var r = function() {
        l.cluster && l.cluster.id && n.cluster.getNamespace(l.cluster.id).then(function(e) {
          var n = e || [];
          l.namespaceSelectorList = [],
          n.forEach(function(e) {
            "default" === e.name && (l.value.namespace = e.name),
            l.namespaceSelectorList.push({
              text: e.name,
              value: e.name
            })
          }),
          n.length > 0 && null == l.value.namespace ? l.value.namespace = n[0].name: 0 === n.length && l.value.isExistentNamespace && (l.value.namespace = null),
          l.isLoadingNamespace = !1
        }).
        catch(function(e) {
          l.isLoadingNamespace = !1,
      ...
      l.toggleNamespaceFillInType = function() {
        l.value.isExistentNamespace ? (a = l.ngModel.namespace, l.value.namespace = null) : l.value.namespace = a,
        l.value.isExistentNamespace = !l.value.isExistentNamespace
      },
      e.$watch("$ctrl.cluster", r),
      e.$watch("$ctrl.value",
      function() {
        l.ngModel = l.value
      })
  ...
  e.component("formMultipleSelectList", {
    ...
    function(e, n, t) {
      ...
      e.$watch("$ctrl.parameters", r, !0),
      e.$watch("$ctrl.getListFn", r),
      e.$watch("$ctrl.ngModel", o.input)
    }]
  }),
  e.component("formSelectList", {
    ...
    function(e, n, t, o) {
      ...
      e.$watch("$ctrl.parameters", i, !0),
      e.$watch("$ctrl.getListFn", i),
      e.$watch("$ctrl.ngModel", l.input)
    }]
  })
...
function _toConsumableArray(r) {
  if (Array.isArray(r)) {
    for (var t = 0,
    e = Array(r.length); t < r.length; t++) e[t] = r[t];
    return e
  }
  return Array.from(r)
} !
  ...
  function(o) {
    ...
    return t.prototype = {
      ...
      finishLoading: function(o) {
        ...
        t = !1;
        n.loadingItems[o] = !1,
        angular.forEach(n.loadingItems,
        function(o) {
          o && !t && (t = !0)
        }),
        n.isLoading = t
...
function(e, t) {
  function n(e, n, i, o, r, a, s, l, c, u, f) {
    ...
    y = function() {
      function a(e) {
        ...
        this.nodeListIns = n.getInstance("NodeList"),
        this.nodeListForIps = [],
        this.clusterListIns = n.getInstance("ClusterList"),
      ...
      return _createClass(a, [{
        ...
        value: function(e) {
          ...
          r = -1;
          c.isObject(e) || (e = {}),
          e.deploymentType || (e.deploymentType = "DEPLOYMENT"),
          e.volumeDrafts || (e.volumeDrafts = []),
          e.versionType || (e.versionType = "CUSTOM"),
          "YAML" !== e.versionType && "JSON" !== e.versionType || (e.versionString = e.versionString || {},
          e.versionString.podSpec = e.versionString.padSpec || ""),
          "number" != typeof e.replicas && (e.replicas = 3),
          c.isArray(e.loadBalanceDrafts) || (e.loadBalanceDrafts = []),
          c.isArray(e.innerServiceDrafts) || (e.innerServiceDrafts = []),
          c.isArray(e.currentVersions) || (e.currentVersions = []);
          var a = !0,
          s = !1,
          l = t;
          try {
          ...
          if (this.config = e, this.addLoadBalance(), this.addInnerService(), this.config.networkMode || (this.config.networkMode = "DEFAULT"), this.config.accessType || (this.config.accessType = "K8S_SERVICE"), i = this.config.currentVersions, this.config.deployId) {
            null === this.versionList && (this.loadingIns.startLoading("versions"), v.getVersions(this.config.deployId).then(function(e) {
              n.versionList = e.data.result || [],
              0 === i.length && c.isObject(n.versionList[0]) && n.toggleVersion(n.versionList[0].version)
            }).
            finally(function() {
              n.loadingIns.finishLoading("versions")
            }));
            for (var C = 0,
            L = i.length; C < L; C++) i[C].createTime > r && (r = i[C].createTime, o = i[C].version);
        ...
        value: function() {
          ...
          try {
            for (var h, v = this.config.containerConsoles[Symbol.iterator](); ! (u = (h = v.next()).done); u = !0) {
              var y = h.value;
              this.addLogDraft(y),
              this.linkVolumeMountToVolume(y, this.config.volumeDrafts)
            }
          } catch(e) {
            f = !0,
            d = e
      ...
      {
        key: "setCollectionIdName",
        value: function(e,h) {
        	this.config.collectionId = e
        	this.config.collectionName = h
          this.collectionId = e
        }
      },
      {
        ...
        value: function() {
          var e = this;
          return this.loadingIns.startLoading("cluster"),
          d.getData().then(function(t) {
            e.clusterListIns.init(t.data.result),
            e.toggleCluster()
          }).
          finally(function() {
      ...
      },
      {
        ...
        value: function() {
          ...
          v.getVersions(this.config.deployId).then(function(t) {
      ...
      },
      {
        ...
        value: function(e) {
          ...
          if (0 !== o.length) {
            if (void 0 === e) {
              for (var r = 0,
              a = o.length; r < a; r++) if (o[r].id === this.config.clusterId) {
                e = r;
                break
              }
              void 0 === e && (e = 0)
            }
            this.clusterListIns.toggleCluster(e),
            this.logConfig = o[e].logConfig,
            i = this.clusterListIns.cluster.id,
             //this.initStorageVolumeList(i),
            this.loadingIns.startLoading("nodelist"),
            d.getNodeList(i).then(function(e) {
              var i = e.data.result || [];
              ...
              for (var o = 0; o < n.nodeListForIps.length; o++) {
                ...
                } else n.nodeListForIps.splice(o, 1),
                o--
              }
              if (n.nodeListIns.init(i, n.config.stateful), n.initSelectedLabels(), n.nodeListIns.toggleEnv(n.config.hostEnv), n.config.stateful && n.config.replicas && n.nodeListIns.nodeList) for (var d = 0,
              h = n.nodeListIns.nodeList.length; d < h && d < n.config.replicas; d++) n.nodeListIns.nodeList[d].isSelected = !0,
              n.nodeListIns.toggleNodeCheck(n.nodeListIns.nodeList[d])
            },
            function() {
              n.nodeListIns.init()
            }).
            ...
            void 0 === this.config.deployId && (this.loadingIns.startLoading("namespace"), d.getNamespace(i).then(function(e) {
              n.namespaceList = e.data.result || [],
              n.isNewNamespace = !1,
              n.config.namespace = n.namespaceList[0].name || null;
              for (var t = 0,
              i = n.namespaceList.length; t < i; t++) if ("default" == n.namespaceList[t].name) {
      ...
      },
      {
        ...
        value: function(e) {
          ...
          v.getSingleVersion(this.config.deployId, e).then(function(e) {
      ...
      
      {
        ...
        value: function() {
          for (var e = this,
          t = this.config.containerConsoles,
          n = 0,
          o = t.length; n < o; n++) {
            t[n].oldEnv = [],
            t[n].newEnv = [],
            function(t) {
              e.loadingIns.startLoading("tag"),
              i.imageService.getImageTags(t.image, t.registry).then(function(e) {
            ...
            for (var r = [], a = 0, s = this.imageList.length; a < s; a++) if (this.imageList[a].imageName === t[n].image) {
              r = this.imageList[a].envSettings;
              break
            }
            if (t[n].envs) for (var l = 0,
            c = t[n].envs.length; l < c; l++) {
              for (var u = !1,
              f = 0,
              d = r.length; f < d; f++) if (r[f].key === t[n].envs[l].key) {
                u = !0;
                break
              }
      ...
      },
      {
        ...
        value: function() {
          var e = [];
          e.push("noAccess"),
          "HOST" === this.config.networkMode && e.push("access"),
          "DEFAULT" === this.config.networkMode && e.push("internal", "foreign"),
          e.indexOf(this.visitMode) === -1 && (this.visitMode = e[0])
        }
      },
      {
        key: "toggleNamespace",
      ...
      },
      {
        key: "toggleEnv",
        value: function(e) {
          this.config.hostEnv = e.value,
          this.envText = e.text,
          this.nodeListIns.toggleEnv(e.value)
        }
      },
      {
        key: "toggleCreator",
      ...
      },
      {
        ...
        value: function(e, t) {
          e.volumePVC.volumeId = t.storageVolumeDraft.id,
          e.volumePVC.volumeName = t.storageVolumeDraft.name,
          e.volumePVC.claimName = t.storageVolumeDraft.name
        }
      },
      {
        ...
        value: function(e, t) {
          ...
          i = n.indexOf(e);
          n.splice(i, 1),
          this.deleteVolumeMountDraftByVolume(e, t)
        }
      },
      {
        key: "addVolumeDraft",
      ...
      },
      {
        ...
        value: function(e) {
          ...
          i.imageService.getImageTags(e.imageName, e.registry).then(function(n) {
            var i = n.data.result;
      ...
      },
      {
        key: "addLogDraft",
        value: function(e) {
          e.logItemDrafts = e.logItemDrafts || [],
          e.logItemDrafts.push({
            logPath: "",
            autoCollect: !1,
            autoDelete: !1
          })
      ...
      },
      {
        ...
        value: function(e, t) {
          e.volumeMountDrafts = e.volumeMountDrafts || [],
          e.volumeMountDrafts = e.volumeMountDrafts.filter(function(e) {
            var n = t.filter(function(t) {
              return t.name === e.name
            })[0];
            if (n) return e._volume = n,
            !0
          })
        }
      },
      ...
      },
      {
        ...
        value: function(e, t) {
          t.forEach(function(t) {
            t.volumeMountDrafts = t.volumeMountDrafts || [],
            t.volumeMountDrafts = t.volumeMountDrafts.filter(function(t) {
              return t._volume !== e
            })
          })
        }
      },
      {
        ...
        value: function(e, t) {
          t.forEach(function(t) {
            t.volumeMountDrafts = t.volumeMountDrafts || [],
            t.volumeMountDrafts.forEach(function(t) {
      ...
      },
      {
        ...
        value: function() {
          ...
          return "HOST" == n.networkMode ? (n.loadBalanceDrafts = [], n.accessType = "DIY", n.innerServiceDrafts = [], "noAccess" == this.visitMode && (n.exposePortNum = 0)) : (n.exposePortNum = 0, "noAccess" == this.visitMode ? (n.accessType = "DIY", n.loadBalanceDrafts = [], n.innerServiceDrafts = []) : "internal" == this.visitMode ? (n.accessType = "K8S_SERVICE", n.innerServiceDrafts[0].targetPort = n.innerServiceDrafts[0].port, n.loadBalanceDrafts = []) : (n.accessType = "K8S_SERVICE", n.innerServiceDrafts = [])),
          n.loadBalanceDrafts = function() {
            var i = [],
            o = [],
            r = !0,
            a = !1,
          ...
          n.stateful ? n.hostList = this.nodeListIns.getSelectedNodes() : n.labelSelectors = this.nodeListIns.getFormartSelectedLabels(),
          n.clusterId = this.clusterListIns.cluster.id,
          n.collectionId = this.collectionId,
          "CUSTOM" === n.versionType ? n.containerConsoles = function() {
            ...
            if (n.containerConsoles) {
              ...
              try {
                for (var l, c = n.containerConsoles[Symbol.iterator](); ! (r = (l = c.next()).done); r = !0) {
                  var u = l.value;
                  e = u.oldEnv,
                  u.healthChecker || (u.healthChecker = {
                    type: "NONE"
                  }),
                  o = {
                    ...
                    try {
                      for (var a, s = e[Symbol.iterator](); ! (i = (a = s.next()).done); i = !0) {
                        ...
                        if ("" !== l.logPath) {
                          ...
                          l.autoCollect && (c.logTopic = l.logTopic, c.processCmd = l.processCmd),
                          l.autoDelete && (c.logExpired = l.logExpired),
                          n.push(c)
                        }
                      }
                    } catch(e) {
          ...
          } () : "JSON" !== n.versionType && "YAML" !== n.versionType || n.versionString && (n.podSpecStr = n.versionString.podSpecStr, delete n.versionString),
          n
        }
      },
      {
        ...
        value: function(e) {
          ...
          return v.createVersion(o).then(function(e) {
            if ("RUNNING" != t.config.deploymentStatus) r.alert("新建成功", "新建部署版本成功,当前状态不能升级。"),
            n.resolve("create");
            else {
              s.open({
                animation: !0,
                ...
                v.updateDeploy(t.config.deployId, e.data.result, i).then(function() {
                  r.alert("正在升级", "已提交，正在升级！"),
                  n.resolve("update")
                },
                function(e) {
                  1007 === e.data.resultCode ? r.
                  ...
                  }) : r.error("升级失败！", e.data.resultMsg),
                  n.resolve("updateFailed")
                })
              },
              function() {
                n.resolve("dismiss")
          ...
          function(e) {
            r.error("创建版本失败！", e.data.resultMsg),
            n.reject("create")
          }),
          n.promise
        }
      },
      {
        ...
        value: function(e) {
          ...
          return v.createVersion(e).then(function(e) {
            if ("RUNNING" != t.config.deploymentStatus) r.alert("新建部署版本成功,当前状态不能升级。"),
            n.resolve("create");
            else {
              s.open({
                animation: !0,
      ...
      },
      {
        ...
        value: function(t) {
          ...
          return s.open({
            ...
            if ((t = parseInt(t)) === n.config.currentReplicas) return r.error("警告", "实例个数无变化！"),
            void i.reject();
        ...
        value: function() {
          ...
          if (this.isNewNamespace) {
            ...
            d.setNamespace(this.clusterListIns.cluster.id, a).then(function() {
              n.toggleIsNewNamespace(),
              n.namespaceList.push(r),
              n.toggleNamespace(r),
              t()
            },
            function(e) {
      ...
      },
      {
        ...
        value: function(t) {
          ...
          return n.podSpecStr = "",
          e.post("api/deploy/deploymentstr", angular.toJson(n))
        }
      }]),
      a
    } (),
    g = function() {
      ...
      },
      {
        ...
        value: function(e) {
          this.isCheckAllContainer = !1,
          this.selectedContainerCount = 0,
          this.containerList = e.containers || [];
          var n = !0,
          i = !1,
          o = t;
          try {
        ...
        value: function(e) {
          ...
          try {
            for (var r, a = this.instanceList[Symbol.iterator](); ! (n = (r = a.next()).done); n = !0) {
              var s = r.value;
              s.isSelected = !1,
              s.keyFilter = s.instanceName.indexOf(e) !== -1
            }
          } catch(e) {
            i = !0,
            o = e
      ...
      },
      {
        ...
        value: function(e) {
          ...
          } else this.selectedContainerCount--,
          this.isCheckAllContainer = !1
        }
      },
      {
        ...
        value: function(e) {
          this.isCheckAllContainer = void 0 === e ? !this.isCheckAllContainer: e,
    ...
    p = function() {
      function e(t) {
        ...
        this.isLoading = !1,
        this.deployList = [],
        this.deployInstanceListIns = new g,
        this.init(t)
      }
      return _createClass(e, [{
        key: "init",
      ...
      },
      {
        ...
        value: function(e, t, n, i, o) {
          ...
          return e ? (this.deploy.id = e, this.deploy.name = t, this.deploy.namespace = n, this.isLoading = !0, i || (o && "deploy" !== o ? "loadBalance" === o && f.loadBalance.loadBalance.listInstance(e).then(function(e) {
            r.deployInstanceListIns.init(e),
            a.resolve()
          }).
            ...
            r.deployInstanceListIns.init(e.data.result),
            a.resolve()
          }).
          finally(function() {
            a.reject(),
            this.isLoading = !1
          }))) : (this.deploy.id = null, this.deploy.name = null, this.deploy.namespace = null, this.deployInstanceListIns.init(), a.reject()),
          a.promise
        }
      },
      {
        ...
        value: function(e, n, i) {
          ...
          try {
            for (var u, f = this.deployList[Symbol.iterator](); ! (s = (u = f.next()).done); s = !0) {
              var d = u.value;
              d.clusterFilter = !e || d.clusterName === e,
              d.hostFilter = !n || d.hostEnv === n,
              void 0 === o && d.clusterFilter && d.hostFilter && (o = d.deployId, r = d.deployName, a = d.namespace)
            }
          } catch(e) {
            l = !0,
            c = e
  ...
  n.$inject = ["$http", "$domeCluster", "$domeImage", "$domePublic", "dialog", "$domeModel", "$modal", "$q", "$util", "$sce", "api"],
  i.factory("$domeDeploy", n),
  e.deployModule = i
} (window);
"use strict";
function _classCallCheck(e, t) {
...
function(e, t) {
  function n(e, t, n) {
    ...
    a = function(e) {
      ...
      return n.danger("确认删除", "确认要删除吗？").then(function(e) {
        ...
        function() {
          r.reject(),
          n.error("删除失败", res.data.resultMsg)
        })
      },
      function() {
        r.reject()
    ...
    u = function(e, r, a) {
      ...
      return n.danger("删除", "该镜像名下，image id相同的所有版本都会被删除，请慎重操作").then(function(e) {
        ...
        function(e) {
          u.reject(),
          n.error("删除失败！", e.data.errors.message + e.data.resultMsg)
        })
      },
      function() {
        u.reject()
  ...
  n.$inject = ["$http", "$q", "dialog"],
  r.factory("$domeImage", n),
  e.imageModule = r
} (window);
"use strict";
function _classCallCheck(e, t) {
...
function(e, t) {
  function i(e, i, r, n, a, o, s, l) {
    var u = function() {
      ...
      a.ServiceModel.call(this, this.url),
      this.getProjectCollectionNameById = function(t) {
    ...
    m = function() {
      ...
      return _createClass(e, [{
        ...
        value: function(e) {
          e || (e = {}),
          i.isArray(e.compilePublicImageList) || (e.compilePublicImageList = []),
          i.isArray(e.compilePrivateImageList) ? e.compilePrivateImageList = this.privateRegistryImageList: e.compilePrivateImageList = [],
          i.isArray(e.runPublicImageList) || (e.runPublicImageList = []),
          i.isArray(e.runPrivateImageList) ? e.runPrivateImageList = this.privateRegistryImageList: e.runPrivateImageList = [],
          angular.forEach(e,
          function(e, r) {
            var n = !0,
            a = !1,
            ...
            try {
              for (var s, l = e[Symbol.iterator](); ! (n = (s = l.next()).done); n = !0) {
                var u = s.value;
                u.createDate = i.getPageDate(u.createTime),
                u.imageTxt = u.imageName,
                u.imageTag && (u.imageTxt += ":" + u.imageTag)
              }
            } catch(e) {
              a = !0,
              o = e
          ...
          this.projectImagesInfo = e,
          0 === Object.keys(this.selectedCompileImage).length && (this.toggleIsPublicImage("compile"), this.toggleIsPublicImage("run"))
        }
      },
      {
        ...
        value: function(e) {
          ...
          l.imageService.getForBuildImages().then(function(r) {
            for (var n = r.data.result || [], a = [], o = 0; o < n.length; o++) {
              var s = n[o];
              s.createDate = i.getPageDate(s.createTime),
              s.imageTxt = s.imageName,
              s.registryUrl = s.registry,
              s.registryType = 0,
              s.imageTag && (s.imageTxt += ":" + s.imageTag),
              a.push(s)
            }
      ...
      },
      {
        ...
        value: function(e, t) {
          void 0 === t && (t = "compile" == e ? this.imageInfo.compileIsPublic: this.imageInfo.runIsPublic),
          "compile" == e ? (this.currentCompileList = 1 === t ? this.projectImagesInfo.compilePublicImageList: this.projectImagesInfo.compilePrivateImageList, this.toggleImage("compile", 0)) : (this.currentRunList = 1 === t ? this.projectImagesInfo.runPublicImageList: this.projectImagesInfo.runPrivateImageList, this.toggleImage("run", 0))
        }
      },
      {
        ...
        value: function(e, t, i) {
          if ("compile" === e) {
            ...
            for (var r = 0; r < this.currentCompileList.length; r++) if (this.currentCompileList[r].imageName === i.imageName) {
            ...
            for (var n = 0; n < this.currentRunList.length; n++) if (this.currentRunList[n].imageName === i.imageName) {
      ...
      },
      {
        key: "toggleImage",
        value: function(e, t, i) {
          if ("compile" === e) if (0 === this.imageInfo.compileIsPublic || void 0 === i) {
            this.selectedCompilePrivateImageTag = {},
            void 0 === i && (i = this.currentCompileList[0]);
          ...
          } else if (void 0 !== i) for (var a = 0; a < this.currentCompileList.length; a++) {
          ...
          else if ("run" === e) if (0 === this.imageInfo.runIsPublic || void 0 === i) {
            this.selectedRunPrivateImageTag = {},
            void 0 === i && (i = this.currentRunList[0]);
          ...
          } else if (void 0 !== i) for (var u = 0; u < this.currentRunList.length; u++) {
      ...
      },
      {
        ...
        value: function(e, t) {
          var r = "";
          i.isObject(t) ? (r = t.imageName, t.imageTag && (r += ":" + t.imageTag)) : t = {},
          "compile" == e ? (this.selectedCompileImage = t, this.selectedCompileImage.imageTxt = r, this.selectedCompilePrivateImageTag.tag = t.imageTag, this.imageInfo.compileIsPublic = void 0 !== t.registryType ? t.registryType: 1, this.currentCompileList = 1 === this.imageInfo.compileIsPublic ? this.projectImagesInfo.compilePublicImageList: this.projectImagesInfo.compilePrivateImageList) : (this.selectedRunImage = t, this.selectedRunImage.imageTxt = r, this.selectedRunPrivateImageTag.tag = t.imageTag, this.imageInfo.runIsPublic = void 0 !== t.registryType ? t.registryType: 1, this.currentRunList = 1 === this.imageInfo.compileIsPublic ? this.projectImagesInfo.runPublicImageList: this.projectImagesInfo.runPrivateImageList)
        }
      }]),
      e
    } (),
    f = function() {
      function r(e) {
        ...
        this.customConfig = {},
        this.isUseCustom = !1,
        this.isDefDockerfile = !1,
        this.projectImagesIns = new m,
        this.init(e)
      }
      return _createClass(r, [{
        ...
        value: function(e) {
          ...
          i.isArray(e.envConfDefault) || (e.envConfDefault = []),
          e.envConfDefault.push({
            key: "",
            value: "",
            description: ""
          }),
          ...
          this.customConfig.uploadFileInfos = function(e) {
            return e || (e = []),
            e.length || e.push({
              filename: "",
              content: ""
      ...
      },
      {
        key: "toggleBaseImage",
        value: function(e, t, i) {
          this.customConfig.baseImageName = e,
          this.customConfig.baseImageTag = t,
          this.customConfig.baseImageRegistry = i
        }
      },
      {
      ...
      },
      {
        ...
        value: function() {
          ...
          return n.danger("确认删除", "确认要删除吗？").then(function(e) {
            ...
            function(e) {
              dalog.error("删除失败！", e.data.resultMsg),
              t.reject("fail")
            })
          },
          function() {
        ...
        value: function() {
          ...
          if (this.config.userDefineDockerfile) {
            s.open({
              ...
              e.config.dockerfileInfo.branch = e.config.dockerfileInfo.tag = null,
              e.config.dockerfileInfo[i.type] = i.value,
              t()
            })
          } else t()
        }
  ...
  i.$inject = ["$http", "$util", "$state", "dialog", "$domeModel", "$q", "$modal", "$domeImage"],
  r.factory("$domeProject", i),
  e.projectModule = r
} (window);
"use strict"; !
function(e, t) {
  var n = angular.module("userModule", []);
  n.controller("ModifyPwModalCtr", ["$scope", "loginUser", "$modalInstance", "dialog", "$domeUser",
  function(e, t, n, o, r) {
    e.pwObj = {
      username: t.username,
      oldpassword: "",
  ...
  }]).controller("ModifyUserInfoCtr", ["$scope", "user", "$publicApi", "$modalInstance", "dialog",
  function(e, t, n, o, r) {
    e.user = t,
    e.cancel = function() {
      o.dismiss()
  ...
  n.factory("$domeUser", ["$http", "$q", "dialog", "$domeGlobal", "$domeModel",
  function(e, t, n, o, r) {
    var i = {},
    u = function(r) {
      var i = t.defer();
...
function(e) {
  ...
  function(e, a) {
    e.$on("pageTitle",
    function(e, a) {
      a.title && "" !== a.title && $("title").html(a.title + " - DomeOS")
    }),
...
"use strict"; !
function(n) {
  n.controller("MainCtr", ["$scope", "$timeout",
  function(n, e) {
    n.thinLeftNav = Boolean(Number(localStorage.getItem("thinLeftNav"))),
    n.switchThinNav = function() {
      n.thinLeftNav = !n.thinLeftNav,
      localStorage.setItem("thinLeftNav", String(Number(n.thinLeftNav)))
    };
    var t = function() {
  ...
  n.component("memoryDatabaseWarning", {
    ...
    bindings: {},
    controller: ["api", "dialog", "documentUrl",
    function(n, e, t) {
      var o = this;
      o.documentUrl = t,
      o.isInMemoryDatabase = null,
      o.userHide = !1,
      n.global.isInMemoryDatabase().then(function(n) {
  ...
  n.component("headerAction", {
    ...
    bindings: {},
    controller: ["api", "dialog", "userDialog", "documentUrl", "logoutUrl", "$timeout",
    function(n, e, t, o, a, i) {
      var c = this;
      c.documentUrl = o,
      c.mayEditMyPassword = !1,
      n.user.whoami().then(function(n) {
        var e = n.name,
        t = n.loginType,
        o = n.isAdmin;
        c.user = {
      ...
      angular.element("#header-action-user").on("focusin",
      function() {
        c.showUserMenu = !0,
        i(function() {})
      }),
      angular.element("#header-action-user").on("focusout",
      function() {
        c.showUserMenu = !1,
        i(function() {})
      }),
  ...
  n.component("leftNav", {
    ...
    bindings: {},
    controller: ["$state", "$scope", "$rootScope", "api",
    function(n, e, t, o) {
      e.menu = [];
      var a = function() {
...
"use strict"; !
function(o) {
  o.factory("userDialog", ["dialog", "api",
  function(o, e) {
    var n = {};
      ...
      return o.common({
        ...
        function(n) {
          ...
          n.onbeforeclose = function(e) {
            if (e === o.button.BUTTON_OK) return n.formSubmit(),
            !1
          },
          n.formSubmit = function() {
            n.modifyInfo.$setSubmitted(),
            n.modifyInfo.$invalid || e.user.modify(n.data).then(function() {
      ...
      return o.common({
        ...
        function(r) {
          ...
          r.onbeforeclose = function(e) {
            if (e === o.button.BUTTON_OK) return r.modifyPassword.$setSubmitted(),
            r.modifyPassword.$invalid || r.formSubmit(),
            !1
          },
          r.formSubmit = function() {
            ...
            r.isAdmin ? {}: {
              ...
              if (r.isAdmin) {
                var e = void 0;
                e = n === r.currentUser ? o.tip("修改密码成功", "您的密码已修改，下次登录时请使用新密码登录。") : o.tip("修改密码成功", "用户 " + n + " 的密码已修改，下次登录时请使用新密码登录。"),
                e.then(function() {
...
"use strict"; !
function(e, r) {
  void 0 !== e && e.filter("listPage",
  function() {
    return function(e, r, t) {
      return e ? (t = parseInt(t), e.slice(r * (t - 1), r * t)) : []
    }
  }).filter("deployOptions",
  function() {
  ...
  function() {
    return function(e, r, t) {
      ...
      if (!t) return e;
      for (var a = 0,
      i = e.length; a < i; a++) e[a][r].toString().indexOf(t) !== -1 && n.push(e[a]);
      return n
    }
  }).filter("mirrorOptions",
  function() {
    return function(e, r, t, n, a) {
      for (var i = [], u = 0, c = e.length; u < c; u++) {
        var f = 0 === e[u].autoCustom ? "dockerfile": "configfile"; (r.All || r[e[u].state]) && (t.All || t.own && e[u].username == a) && (n.All || n[f]) && i.push(e[u])
      }
      return i
    }
  ...
  function(e) {
    return function(r, t) {
      if (r) {
        for (var n, a, i = [], u = 0, c = r.length; u < c; u++) n = r[u],
        a = e("date")(n.timeStamp, "yyyy-MM-dd HH:mm:ss"),
        n.alarmObject.indexOf(t) === -1 && n.templateTypeName.indexOf(t) === -1 && n.metricName.indexOf(t) === -1 && n.alarmNum.indexOf(t) === -1 && n.alarmTimes.indexOf(t) === -1 && a.indexOf(t) === -1 || i.push(n);
        return i
      }
    }
  }]).filter("urlProtocolFilter",
  function() {
    return function(e) {
      return e ? e.indexOf("http://") !== -1 ? e.substring(7) : e.indexOf("https://") !== -1 ? e.substring(8) : "": ""
    }
  }).filter("eventOperation",
  function() {
    return function(e) {
      var r = "";
      switch (e) {
...
"use strict"; !
function(e, o) {
  void 0 !== e && e.factory("$domeProjectCollection", ["$http", "$q", "dialog", "$domeGlobal", "$domeModel",
  function(e, o, t, n, c) {
    var r = {
...
"use strict"; !
function(e, o) {
  void 0 !== e && e.factory("$domeDeployCollection", ["$http", "$q", "dialog", "$domeGlobal", "$domeModel",
  function(e, o, t, n, l) {
...
"use strict"; !
function(t, e) {
  void 0 !== t && t.factory("$domeAppStore", ["$http", "$domeDeploy","$domeDeployCollection",
  function(t, e,m) {
    var a = function() {
      return t.get("/api/appstore", {
        notIntercept: !0
      })
    },
    r = function() {};
    ...
    return r.prototype = {
      ...
      formartToDeploy: function() {
        var t = {};
        t = angular.copy(this.config.deploymentTemplate),
        console.log("this.config.deploymentTemplate");
        console.log(t);
        t.deployName = this.config.appName + parseInt(1e4 * Math.random()),
        t.podSpecStr="";
        t.containerConsoles=t.containerDrafts;
        this.deployIns = e.getInstance("Deploy", t)
      }
    },
    {
      getStoreApps: a,
  ...
  }]).factory("$domeGlobal", ["$http", "dialog", "$q",
  function(t, e, a) {
    var r = function(r) {
      var n = function() {
        var t;
      ...
      this.getData = function() {
        var e = a.defer();
        return t.get(n).then(function(t) { ! t.data.result || "git" == r && 0 === t.data.result.length ? e.reject() : (o = !1, e.resolve(t.data.result))
        },
        function(t) {
      ...
      this.modifyData = function(i) {
        ...
        return "git" === r && void 0 !== i.id && (o = !1),
        o || "registry" === r ? t.post(n, angular.toJson(i)).then(function(t) {
          o = !1,
          c("添加成功！"),
          s.resolve(t.data.result)
        },
        function(t) {
          l(t.data.resultMsg),
          s.reject()
...
"use strict"; !
function(t, e) {
  void 0 !== t && t.factory("$domeCluster", ["$http", "$q", "$modal", "dialog", "$domeModel", "$util",
  function(t, e, i, n, r, o) {
    var s = function() {
      var i = this;
      this.url = "/api/cluster",
      r.ServiceModel.call(this, this.url);
    ...
    a.prototype = {
      init: function(t, e) {
        ...
        this.labelsInfo = function() {
          ...
          e = i.nodeList,
          n = 0,
          r = e.length; n < r; n++) for (var o in e[n].labels) if (e[n].labels.hasOwnProperty(o) && "kubernetes.io/hostname" != o && "hostEnv" != o) if (t[o]) {
            for (var s = !1,
            l = 0,
            a = t[o].contents.length; l < a; l++) if (t[o].contents[l] === e[n].labels[o]) {
              s = !0;
              break
            }
      ...
      toggleEnv: function(t) {
        "PROD" != t && "TEST" != t || (this.labelsInfo.TESTENV.isSelected = "PROD" != t, this.labelsInfo.PRODENV.isSelected = "PROD" == t),
        this.toggleLabelNodes()
      },
      ...
      filterWithKey: function(t) {
        ...
        try {
          for (var r, o = this.nodeList[Symbol.iterator](); ! (e = (r = o.next()).done); e = !0) {
            var s = r.value;
            s.isSelected = !1,
            s.keyFilter = s.name.indexOf(t) !== -1
          }
        } catch(t) {
          i = !0,
          n = t
      ...
      checkAllNode: function(t) {
        this.isCheckAll = void 0 === t ? this.isCheckAll: t,
        this.selectedCount = 0;
        var e = !0,
        i = !1,
        n = void 0;
      ...
      toggleLabelNodes: function() {
        var t = !1;
        if (this.isCheckAll = !1, this.selectedCount = 0, angular.forEach(this.labelsInfo,
        function(e) { ! t && e.isSelected && (t = !0)
        }), t) {
          var e = !0,
          i = !1,
          n = void 0;
          try {
            for (var r, o = this.nodeList[Symbol.iterator](); ! (e = (r = o.next()).done); e = !0) {
              ...
              l = !0;
              s.isSelected = !1;
              for (var a in this.labelsInfo) if (this.labelsInfo.hasOwnProperty(a) && this.labelsInfo[a].isSelected && void 0 === s.labels[a]) {
                l = !1;
                break
              }
              s.labelFilter = l
      ...
      getFormartSelectedLabels: function() {
        var t = [];
        return angular.forEach(this.labelsInfo,
        function(e, i) {
          if (e.isSelected) for (var n = 0,
          r = e.contents.length; n < r; n++) t.push({
            name: i,
    ...
    c.prototype = {
      ...
      init: function(t) {
        ...
        t.clusterLog.kafka = s,
        t.isHttps = void 0 !== t.api && 0 === t.api.indexOf("https://"),
        t.isHttps && (t.api = t.api.substring(8)),
        t.logConfig || (t.logConfig = 0),
        this.config = t
      },
      addEtcd: function() {
      ...
      validItem: function(t) {
        ...
        else for (var i = "etcd" == t ? this.config.etcd: this.config.clusterLog[t] || [], n = 0, r = i.length; n < r; n++) if (i[n].name && "" !== i[n].name) {
          e = !0;
          break
        }
        switch (t) {
      ...
      _formartCluster: function() {
        ...
        return t.isHttps ? t.api = "https://" + t.api: t.username = t.password = void 0,
        t.isHttps = void 0,
        t
      },
      _formartNewCluster: function(t) {
        var e = {};
        return e.clusterInfo = t,
        e
      },
      create: function() {
    ...
    return u.prototype = {
      ...
      toggleCluster: function(t) {
        this.cluster.id = this.clusterList[t].id,
        this.cluster.name = this.clusterList[t].name
      }
    },
    {
...
"use strict"; !
function(t, e) {
  void 0 !== t && t.factory("$domeMonitor", ["$http", "$q", "$util", "dialog",
  function(t, e, n, i) {
    var o = function() {
    ...
    return {
      ...
      getMonitorStatistical: function(t, i, o, a) {
        ...
        function c(t, e) {
          return t = n.formartBytesData(t, e),
          "[object Null]" === Object.prototype.toString.call(t) || void 0 === t ? "——": +t.toFixed(2)
        }
        var d = e.defer();
        return r({
          clusterId: i,
          ...
          function n(t, e, n, i) {
            ...
            angular.forEach(n,
            function(t, n) {
              for (var a in t) if (t.hasOwnProperty(a) && "timeStamp" !== a && f[a]) {
                var u;
          ...
          if ("node" == t) {
            ...
            angular.forEach(l.counterResults,
            function(t, e) {
              var n = e.split("=")[1];
            ...
            n("diskUsed", "MAX", p.diskUsedMap, "%"),
            n("diskRead", "SUM", p.diskReadMap, "KB"),
            n("diskWrite", "SUM", p.diskWriteMap, "KB"),
            n("netIn", "SUM", p.netInMap, "KB"),
            n("netOut", "SUM", p.netOutMap, "KB")
          } else if ("pod" == t || "container" == t) for (i = l.counterResults["container.cpu.usage.busy"].slice( - 3, -2)[0], o = l.counterResults["container.mem.usage.percent"].slice( - 3, -2)[0], p = {
...
function(t, e) {
  void 0 !== t && t.factory("$domeAlarm", ["$domeModel", "$domeUser", "$domeDeploy", "$domeCluster", "$http", "$domePublic", "dialog", "$q", "$util",
  function(t, e, i, r, o, n, s, a, l) {
    var u = function() {
      t.ServiceModel.call(this, "/api/alarm/template")
    },
    c = function() {
      t.ServiceModel.call(this, "/api/alarm/hostgroup"),
      this.addHost = function(t, e) {
    ...
    h = function() {
      t.ServiceModel.call(this, "/api/alarm/usergroup"),
    ...
    d = function() {
      function t(e) {
        ...
        this.keyMaps = g,
        this.groupList = [],
        this.deployListIns = i.getInstance("DeployList"),
        this.loadingIns = n.getLoadingInstance(),
        this.clusterList = [],
        this.init(e)
      }
      return _createClass(t, [{
        ...
        value: function(t) {
          ...
          l.isObject(t.deploymentInfo) || (t.deploymentInfo = {}),
          l.isArray(t.strategyList) || (t.strategyList = []),
          l.isObject(t.callback) || (t.callback = {}),
          l.isArray(t.hostGroupList) || (t.hostGroupList = []);
          var e = !0,
          i = !1,
          r = void 0;
          try {
          ...
          this.config = t,
          void 0 === this.config.id && (this.config.deploymentInfo.hostEnv || (this.config.deploymentInfo.hostEnv = "PROD"), this.addStrategy())
        }
      },
      {
        ...
        value: function() {
          ...
          i = function() {
            ...
            u = t.hostGroupList.length; l < u; l++) {
              i = !1;
              for (var c = 0,
              h = e.length; c < h; c++) if (e[c].id === t.hostGroupList[l].id) {
                i = !0;
                break
              }
      ...
      },
      {
        ...
        value: function() {
          ...
          i = function() {
            var i = void 0;
            if (e && 0 !== e.length) for (var r = 0,
            o = t.groupList.length; r < o; r++) {
              i = !1;
              for (var n = 0,
              s = e.length; n < s; n++) if (t.groupList[r].id === e[n].id) {
                i = !0;
                break
              }
              t.groupList[r].isSelected = i
            } else for (var a = 0,
            l = t.groupList.length; a < l; a++) t.groupList[a].isSelected = !1
          };
          0 === this.groupList.length ? (this.loadingIns.startLoading("groupList"), o.get("/api/alarm/usergroup").then(function(e) {
            t.groupList = e.data.result || [],
            i()
          },
          function() {
            s.error("警告", "获取组信息失败！")
      ...
      },
      {
        ...
        value: function() {
          ...
          0 === this.deployListIns.deployList.length ? (this.loadingIns.startLoading("deploy"), a.all([i.deployService.getList(), p.getData()]).then(function(i) {
            t.deployListIns.init(i[0].data.result),
            t.clusterList = i[1].data.result || [],
            e.clusterName ? (t.toggleHostEnv(e.hostEnv), t.deployListIns.deploy.id = e.id, t.deployListIns.deploy.name = e.deploymentName) : (e.clusterName = t.clusterList[0].name, t.toggleCluster(t.clusterList[0].name))
          },
          function() {
            s.error("警告", "获取信息失败！")
          }).
      ...
      },
      {
        key: "toggleHostEnv",
        value: function(t) {
          this.config.deploymentInfo.hostEnv = t,
          this.deployListIns.filterDeploy(this.config.deploymentInfo.clusterName, t)
        }
      },
      {
        key: "toggleCluster",
        value: function(t) {
          this.config.deploymentInfo.clusterName = t,
          this.deployListIns.filterDeploy(t, this.config.deploymentInfo.hostEnv)
        }
      },
      {
        ...
        value: function() {
          ...
          if (t.templateName = this.config.templateName, t.templateType = this.config.templateType, t.id = this.config.id, "host" == t.templateType) {
            t.templateType = this.config.templateType,
            t.hostGroupList = [];
            for (var e = 0,
            i = this.hostGroupList.length; e < i; e++) this.hostGroupList[e].isSelected && t.hostGroupList.push({
          ...
          try {
            for (var s, a = this.config.strategyList[Symbol.iterator](); ! (r = (s = a.next()).done); r = !0) {
              var l = s.value,
              u = angular.copy(l);
              "agent_alive" == u.metric && (u.rightValue = 1, u.operator = "<"),
              u.tag && ("disk_percent" == u.metric ? u.tag = "mount=" + u.tag: u.metric.indexOf("disk") !== -1 ? u.tag = "device=" + u.tag: u.metric.indexOf("network") !== -1 && (u.tag = "iface=" + u.tag)),
              t.strategyList.push(u)
            }
          } catch(t) {
            o = !0,
            n = t
          ...
          t.userGroupList = [];
          for (var c = 0,
          h = this.groupList.length; c < h; c++) this.groupList[c].isSelected && t.userGroupList.push({
            id: this.groupList[c].id
          });
          return t.callback = angular.copy(this.config.callback),
          console.log(t),
          t
        }
      },
    ...
    y = function(t) {
      ...
      },
      {
        ...
        value: function(t) {
          if (_get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "checkAllItem", this).call(this, t), t) {
            ...
            m = void 0;
            try {
              for (var v, L = this.nodeList[Symbol.iterator](); ! (d = (v = L.next()).done); d = !0) for (var b = v.value,
              k = 0; k < this.selectedList.length; k++) {
      ...
      },
      {
        key: "toggleCheck",
        value: function(t, i) {
          if (_get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "toggleCheck", this).call(this, t, i), i) t.cluster = this.clusterName,
          this.selectedList.push({
            name: t.name,
            ip: t.ip,
            cluster: t.cluster
          });
          else for (var r = 0; r < this.selectedList.length; r++) if (this.selectedList[r].name === t.name && this.selectedList[r].cluster === this.clusterName) {
      ...
      },
      {
        ...
        value: function(t) {
          ...
          for (var l = 0; l < this.selectedList.length; l++) if (this.selectedList[l].name === t.name && this.selectedList[l].cluster === t.cluster) {
...
"use strict"; !
function(e, t) {
  void 0 !== e && e.directive("creatorSelection", ["$domeUser",
  function(e) {
    var t = [];
    return t.push('  <div class="com-creator-selection">'),
    t.push('       <div select-con="select-con" class="com-select-con role-select">'),
    t.push("      <button ng-cloak=\"ng-cloak\" class=\"ui-btn ui-btn-white ui-btn-select\">{{userType=='USER'?'个人':'组'}}<i class=\"icon-down\"></i></button>"),
    t.push('      <ul class="select-list">'),
    t.push('        <li class="select-item"><a ng-click="toggleUserType(\'USER\')">个人</a></li>'),
    t.push('        <li class="select-item"><a ng-click="toggleUserType(\'GROUP\')">组</a></li>'),
    t.push("      </ul>"),
    t.push("    </div>"),
    t.push("    <em ng-show=\"userType=='USER'\" ng-bind=\"'当前用户：'+currentUser.name\"></em>"),
    t.push('    <div select-con="select-con" class="com-select-con group-select" ng-show="userType==\'GROUP\'">'),
    t.push('      <button class="ui-btn ui-btn-white ui-btn-select" ng-cloak>{{currentGroup.name}}<i class="icon-down"></i></button>'),
    t.push('      <ul class="select-list">'),
    t.push('        <li ng-if="roleList.length===0" class="select-item"><a>无组信息</a></li>'),
    t.push('        <li ng-repeat="group in roleList" class="select-item"><a ng-bind="group.name" ng-click="toggleGroup(group)"></a></li>'),
    t.push("      </ul>"),
    t.push("    </div>"),
    t.push("  </div>"),
    {
      ...
      link: function(t, s, n) {
        t.userType = t.defaultUserType || "USER",
        t.currentGroup = {},
        t.currentUser = {},
        ...
        e.userService.getGroupList().then(function(e) {
      	...
      	//alert(t.roleList);
          for (var s = 0; s < t.roleList.length; s++) t.defaultUserId && t.defaultUserType && t.defaultUserId === t.roleList[s].id && t.defaultUserType === t.roleList[s].type && "GROUP" == t.defaultUserType && (t.currentGroup = t.roleList[s], t.toggleGroup(t.roleList[s])),
          "USER" === t.roleList[s].type && (t.currentUser = t.roleList[s], t.roleList.splice(s, 1), s--);
          t.currentGroup.id || t.toggleGroup(t.roleList[0]),
          t.toggleUserType(t.userType)
        })
      }
    }
  }]).directive("listScroll", ["$window", "$document",
  function(e, t) {
    return {
      restrict: "A",
      ...
      link: function(s, n, i) {
        ...
        function(e, t) {
          1 === n.find("li").length ? n.height(0) : n.height("auto"),
          h = o.width() - f,
          d = Math.ceil(e.listWidth / (h - 48)),
          r + 1 > d && p.trigger("click"),
          d <= 1 ? c.hide() : c.show(),
          n.css("max-width", (h > e.listWidth ? e.listWidth + 15 : h) + "px"),
          t.windowWidth !== e.windowWidth && (r = 0, a.css("margin-left", 0))
        },
        !0),
        l.bind("resize",
        function() {
  ...
  function() {
    var e = [];
    return e.push('       <div><div select-con label="true" class="com-select-con">'),
    e.push('        <ul class="selected-labels">'),
    e.push('          <li ng-repeat="item in selectedList=(optionList|filter:{isSelected:true})" ng-cloak="ng-cloak" class="select-label"><a ng-click="toggleSelect(item);itemClick()" class="icon-cancel"></a>{{item[showKey]}}</li>'),
    e.push('          <li class="select-input">'),
    e.push('            <input placeholder="{{placeholder}}" ng-model="keywords.key" ng-keydown="keyDown($event,selectedList,optionListFiltered[0])" class="ui-btn-select"/>'),
    e.push("          </li>"),
    e.push("        </ul>"),
    e.push('        <ul class="select-list">'),
    e.push('          <li ng-show="optionListFiltered.length===0" class="select-item"><a>无相关信息</a></li>'),
    e.push('          <li ng-repeat="item in optionListFiltered=(optionList|dynamicKey:showKey:keywords.key|filter:{isSelected:false})" class="select-item" select-input-item ><a ng-click="toggleSelect(item);itemClick()"></a></li>'),
    e.push("        </ul>"),
    e.push("      </div></div>"),
    {
      restrict: "AE",
      ...
      link: function(e) {
        ...
        e.keyDown = function(t, s, n) { ! e.keywords.key && 8 == t.keyCode && s.length > 0 ? e.toggleSelect(s[s.length - 1]) : 13 == t.keyCode && n && e.toggleSelect(n)
        }
      }
    }
  }).directive("selectInputItem",
  function() {
    return {
      require: "^selectInput",
  ...
  }).directive("loglist", ["$util", "$domeProject", "$filter",
  function(e, t, s) {
    return {
      restrict: "AE",
      template: "<div ng-transclude></div>",
      ...
      link: function(n, i) {
        ...
        var l = function(t) {
          ...
          if (l.push('<tr class="log-detail">'), l.push('   <td colspan="8">'), l.push('       <ul class="detail-list">'), l.push('           <li class="detail-row">'), l.push('               <span class="detail-title">镜像大小</span>'), l.push('               <span class="detail-content">' + i.imageInfo.imageSize + "MB</span>"), l.push("           </li>"), "Success" == i.state && (l.push('           <li class="detail-row">'), l.push('               <span class="detail-title">拉取命令</span>'), l.push('               <span class="detail-content">'), l.push('                   <input id="input' + t + '" class="cmd-txt ui-input-white" readonly="true" value="docker pull ' + i.imageInfo.registry + "/" + i.imageInfo.imageName + ":" + i.imageInfo.imageTag + '"/><a class="link-safe link-copy" id="btn' + t + '" data-clipboard-target="#input' + t + '" data-text="docker pull ' + i.imageInfo.registry + "/" + i.imageInfo.imageName + ":" + i.imageInfo.imageTag + '">复制</a>'), l.push('                   <p class="cmd-prompt"> 拉取镜像前请登录：docker login domeos.io</p>'), l.push("               </span>"), l.push("           </li>")), i.codeInfo && i.commitInfo) {
            l.push('           <li class="detail-row">'),
            l.push('               <span class="detail-title">Branch名称</span>'),
            l.push('               <span class="detail-content">' + i.codeInfo.codeBranch + "</span>"),
            l.push("           </li>"),
            l.push('           <li class="detail-row">'),
            l.push('               <span class="detail-title">author</span>'),
            l.push('               <span class="detail-content">' + (null != i.commitInfo.authorName ? i.commitInfo.authorName: "无") + "</span>"),
            l.push("           </li>"),
            l.push('           <li class="detail-row">'),
            l.push('               <span class="detail-title">author email</span>'),
            l.push('               <span class="detail-content">' + (null != i.commitInfo.authorEmail ? i.commitInfo.authorEmail: "无") + "</span>"),
            l.push("           </li>"),
            l.push('           <li class="detail-row">'),
            l.push('               <span class="detail-title">commit time</span>'),
            l.push('               <span class="detail-content">' + s("day")(i.commitInfo.createdAt) + "</span>"),
            l.push("           </li>"),
            l.push('           <li class="detail-row">'),
            l.push('               <span class="detail-title">commit info</span>'),
            l.push('               <span class="detail-content">' + i.commitInfo.message + "</span>"),
            l.push("           </li>")
          }
          return l.push('           <li class="detail-row">'),
          l.push('               <span class="detail-title">Dockerfile</span>'),
          l.push('               <span id="dockerfile" class="detail-content">加载中……</span>'),
          l.push("           </li>"),
          l.push("       </ul>"),
          l.push("   </td>"),
          l.push("</tr>"),
          e.parseTpl(l.join(""), n.buildList[t])
        },
        o = null;
        n.showDetail = function(e) {
          null != o && o.destroy(),
          o = new Clipboard(".link-copy"),
          e != n.currentIndex ? (i.find(".log-detail").remove(), i.find("tr:eq(" + e + ")").after(l(e)), o.on("error",
          function(e) {
      ...
      link: function(e, t) {
        ...
        function(l) {
          if (n = [], l) {
            ...
            n.push('<span class="pageno next"><i class="icon-next"></i></span>'),
            t.html(n.join(""))
          }
        }),
        t.delegate(".pageno", "click",
        function() {
          var t = angular.element(this);
          t.hasClass("turn") ? (e.pageno = angular.element(this).html(), angular.element(".pageno.on").removeClass("on"), t.addClass("on")) : t.hasClass("last") ? 1 !== e.pageno && "1" !== e.pageno && (e.pageno = parseInt(e.pageno) - 1, angular.element(".pageno.on").removeClass("on").prev(".pageno").addClass("on")) : t.hasClass("next") && e.pageno < s && parseInt(e.pageno) < s && (e.pageno = parseInt(e.pageno) + 1, angular.element(".pageno.on").removeClass("on").next(".pageno").addClass("on")),
          angular.element(".current-page").html(e.pageno),
          e.$apply()
        })
      }
    }
  }).directive("fileCollapse",
  function() {
    return {
      restrict: "A",
      link: function(e) {
        e.showFile = !1,
        e.showContent = !1,
        e.toggleFile = function() {
          e.showFile = !0
        },
        e.toggleContent = function() {
          e.showContent = !e.showContent,
          e.showFile = !0,
          e.showContent || "" !== e.fileInfo.fileName || "" !== e.fileInfo.filePath || (e.showFile = !1)
        }
      }
    }
  }).directive("customlist", ["$util", "$domeProject", "$domeImage",
  function(e, t, s) {
    return {
      restrict: "AE",
      template: "<div ng-transclude></div>",
      ...
      link: function(t, n) {
        ...
        var l = function() {
          ...
          if (s.push('<tr class="custom-detail">'), s.push('   <td colspan="9" class="td-detail">'), s.push('       <ul class="com-list-info detail-list">'), s.push("           <li>"), s.push('               <span class="info-name">定制详情</span>'), s.push('               <span class="info-simple">' + n + "</span>"), s.push("           </li>"), "Success" == t.customDetailInfo.state && (s.push("           <li>"), s.push('               <span class="info-name">镜像大小</span>'), s.push('               <span class="info-simple">{#imageSize}MB</span>'), s.push("           </li>"), s.push("           <li>"), s.push('               <span class="info-name">拉取命令</span>'), s.push('               <div class="info-content cmd-wrap">'), s.push('                   <input class="ui-input-fill" disabled="true" value="docker pull {#registry}/{#imageName}:{#imageTag}"/><button class="ui-btn ui-btn-sm ui-btn-active link-copy" data-text="docker pull {#registry}/{#imageName}:{#imageTag}">复制</button>'), s.push('                   <p class="txt-prompt"> 拉取镜像前请登录：docker login domeos.io</p>'), s.push("               </div>"), s.push("           </li>")), 1 === t.customDetailInfo.autoCustom) {
            s.push("           <li>"),
            s.push('               <span class="info-name">环境变量</span>');
            var l = t.customDetailInfo.envSettings,
            o = l.length;
            if (0 === o) s.push('               <span class="info-simple">无</span>');
            else {
              s.push('               <div class="info-content">'),
              s.push('                   <table class="ui-table-primary">'),
              s.push("                       <tr>"),
              s.push("                           <td>名称</td>"),
              s.push("                           <td>值</td>"),
              s.push("                           <td>描述</td>"),
              s.push("                       </tr>");
              for (var a = 0; a < o; a++) s.push("                       <tr>"),
              s.push("                           <td>" + l[a].key + "</td>"),
              s.push("                           <td>" + l[a].value + "</td>"),
              s.push("                           <td>" + l[a].description + "</td>"),
              s.push("                       </tr>");
              s.push("                   </table>"),
              s.push("               </div>")
            }
          ...
          if (s.push("           <li>"), s.push('               <span class="info-name">定制镜像是否作为基础镜像</span>'), s.push('               <span class="info-simple">' + i + "</span>"), s.push("           </li>"), s.push("           <li>"), s.push('               <span class="info-name">定制镜像描述</span>'), null === t.customDetailInfo.description || "" === t.customDetailInfo.description ? s.push('               <span class="info-simple">无</span>') : s.push('               <span class="info-simple">{#description}</span>'), s.push("           </li>"), s.push("           <li>"), s.push('               <span class="info-name">Dockerfile</span>'), null === t.customDetailInfo.dockerfileContent || "" === t.customDetailInfo.dockerfileContent ? s.push('               <span class="info-simple">无</span>') : (s.push('               <div class="info-content">'), s.push('                   <textarea readonly="true" class="ui-input-fill file-txt">{#dockerfileContent}</textarea>'), s.push("               </div>")), s.push("           </li>"), 1 === t.customDetailInfo.autoCustom && t.customDetailInfo.files) {
            s.push("           <li>"),
            s.push('               <span class="info-name">配置文件</span>');
            var c = t.customDetailInfo.files,
            u = c.length;
            if (u && 0 !== u) {
              s.push('               <div class="info-content">');
              for (var p = 0; p < u; p++) s.push('                   <div class="line-long">'),
              s.push('                       <p class="con-num">' + (p + 1) + "</p>"),
              s.push('                       <span class="config-title">名称:' + c[p].fileName + "</span>"),
              s.push('                       <span class="config-title">容器内路径:' + c[p].filePath + "</span>"),
              s.push("                   </div>"),
              s.push('                   <textarea readonly="true" class="ui-input-fill file-txt">' + c[p].content + "</textarea>");
              s.push("               </div>")
            } else s.push('                   <span class="info-simple">无</span>');
            s.push("           </li>")
          }
          return s.push("           <li>"),
          s.push('               <button class="ui-btn ui-btn-none btn-pack" >收起<i class="icon-down top"></i></button>'),
          s.push("           </li>"),
          s.push("       </ul>"),
          s.push("   </td>"),
          s.push("</tr>"),
          e.parseTpl(s.join(""), t.customDetailInfo)
        };
        e.loadJs("/lib/js/jquery.zclip.js").then(function() {
          i = !0
        });
        ...
        a = function() {
          n.find(".btn-pack").click(function() {
            t.$apply(function() {
              t.currentIndex = -1,
              n.find(".custom-detail").remove()
            })
          })
        };
        t.showDetail = function(c, u) {
          c !== t.currentIndex ? (s.imageService.getCustomImageInfo(u).then(function(s) {
            t.customDetailInfo = s.data.result || {},
            n.find(".custom-detail").remove(),
            n.find("tr:eq(" + c + ")").after(l()),
            a(),
            i ? o() : e.loadJs("/lib/js/jquery.zclip.js").then(function() {
              i = !0,
              o()
            })
  ...
  }]).directive("hoverablePopover", ["$rootScope", "$timeout",
  function(e, t) {
    return {
      restrict: "AE",
      scope: {
      ...
      link: function(s, n) {
        ...
        function() {
          null !== n.context.nextElementSibling && t(function() {
            n.context.nextElementSibling.addEventListener("mouseenter",
            function() {
              e.insidePopover = !0
            }),
            n.context.nextElementSibling.addEventListener("mouseleave",
            function() {
              n.popover("hide"),
              e.insidePopover = !1
            }),
...
function(e, t) {
    ...
    return {
      ...
      link: function(e, t, i, r) {
        ...
        function(e) {
          ...
          i = e.min,
          n = !1,
          s = !1; (isNaN(t) || !isNaN(t) && parseFloat(e.model) <= parseFloat(t)) && (n = !0),
          (isNaN(i) || !isNaN(i) && parseFloat(e.model) >= parseFloat(i)) && (s = !0),
          n && s ? r.$setValidity("isOver", !0) : r.$setValidity("isOver", !1)
        },
        !0)
      }
    }
  }).directive("isProjectExist", ["$domeProject",
  function(e) {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(t, i, r, n) {
        ...
        e.projectService.getProject(t.collection).then(function(e) {
          function i(e) {
            return 1 === s[o + "/" + e] ? n.$setValidity("isProjectExist", !1) : n.$setValidity("isProjectExist", !0),
            e
          }
    ...
    return {
      ...
      link: function(e, t, i, r) {
        r.$parsers.unshift(function(t) {
          if (e.userList) for (var i = 0,
          n = e.userList.length; i < n; i++) if (e.userList[i].username === t) return void r.$setValidity("isUserExist", !1);
          return r.$setValidity("isUserExist", !0),
          t
        })
      }
    }
  }).directive("isClusterExist",
  function() {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(e, t, i, r) {
        r.$parsers.unshift(function(t) {
          if (e.clusterList) for (var i = 0,
          n = e.clusterList.length; i < n; i++) if (e.clusterList[i].name === t) return void r.$setValidity("isClusterExist", !1);
          return r.$setValidity("isClusterExist", !0),
          t
        })
      }
    }
  }).directive("isApiServerExist",
  function() {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(e, t, i, r) {
        r.$parsers.unshift(function(t) {
          if (e.clusterList) for (var i = 0,
          n = e.clusterList.length; i < n; i++) if (e.currentCluster !== e.clusterList[i].name && e.clusterList[i].api === t) return void r.$setValidity("isApiServerExist", !1);
          return r.$setValidity("isApiServerExist", !0),
          t
        })
      }
    }
  }).directive("isDeployExist", ["$domeDeploy",
  function(e) {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(t, i, r, n) {
        function s(e) {
          for (var t = 0,
          i = a.length; t < i; t++) if (a[t].clusterName === u && a[t].namespace === o && a[t].deployName === e) return n.$setValidity("isDeployExist", !1),
          e;
          return n.$setValidity("isDeployExist", !0),
          e
        }
        var a = [],
        o = r.namespace,
  ...
  }]).directive("isDeployNameExist", ["$domeCluster",
  function(e) {
    return {
      require: "ngModel",
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          for (var t = 0,
          i = s.length; t < i; t++) if (s[t].deployName === e) return n.$setValidity("isDeployNameExist", !1),
          e;
          return n.$setValidity("isDeployNameExist", !0),
          e
        })
      }
    }
  }]).directive("isNamespaceExist", ["$domeCluster",
  function(e) {
    return {
      require: "ngModel",
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          for (var t = 0,
          i = s.length; t < i; t++) if (s[t].name === e) return n.$setValidity("isNamespaceExist", !1),
          e;
          return n.$setValidity("isNamespaceExist", !0),
          e
        })
      }
    }
  }]).directive("isGroupExist", ["$domeUser",
  function(e) {
    return {
      require: "ngModel",
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          return s[e] ? n.$setValidity("isGroupExist", !1) : n.$setValidity("isGroupExist", !0),
          e
        })
      }
    }
  }]).directive("isAlarmTemplateExist", ["$domeAlarm",
  function(e) {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          return t.selfName && t.selfName === e ? n.$setValidity("isAlarmTemplateExist", !0) : s[e] ? n.$setValidity("isAlarmTemplateExist", !1) : n.$setValidity("isAlarmTemplateExist", !0),
          e
        })
      }
    }
  }]).directive("isTagExist",
  function() {
    return {
      require: "ngModel",
      scope: {
      ...
      link: function(e, t, i, r) {
        function n(t) {
          var i = !1;
          if (e.imageName && e.baseImages) for (var n = 0,
          s = e.baseImages.length; n < s; n++) if (e.baseImages[n].imageName === e.imageName && e.baseImages[n].imageTag === t) {
            i = !0;
            break
          }
          return r.$setValidity("isTagExist", !i),
          t
        }
        e.$watch(function() {
          return e.imageName
  ...
  function() {
    return {
      ...
      link: function(e, t, i, r) {
        r.$parsers.unshift(function(t) {
          for (var i = 0,
          n = e.hostgroupList.length; i < n; i++) if (t === e.hostgroupList[i].hostGroupName) return r.$setValidity("isHostgroupExist", !1),
          t;
          return r.$setValidity("isHostgroupExist", !0),
          t
        })
      }
    }
  }).directive("diyPattern",
  function() {
    return {
      restrict: "A",
      require: "ngModel",
      ...
      link: function(e, t, i, r) {
        function n(t) {
          if (t = t || "", e.pattern) {
            ...
            return r.$setValidity("diyPattern", i.test(t)),
            t
          }
          return r.$setValidity("diyPattern", !0),
          t
        }
        r.$parsers.unshift(n),
        e.$watch(function() {
  ...
  }]).directive("isProjectCollectionExist", ["$domeProjectCollection",
  function(e) {
    return {
      require: "ngModel",
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          return s[e] ? n.$setValidity("isProjectCollectionExist", !1) : n.$setValidity("isProjectCollectionExist", !0),
          e
        })
      }
    }
  }]).directive("isDeployCollectionExist", ["$domeDeployCollection",
  function(e) {
    return {
      require: "ngModel",
      link: function(t, i, r, n) {
        ...
        n.$parsers.unshift(function(e) {
          return s[e] ? n.$setValidity("isDeployCollectionExist", !1) : n.$setValidity("isDeployCollectionExist", !0),
          e
        })
      }
    }
...
function(n) {
  n.component("hostLabelSelector", {
    ...
    function(n, e, t) {
      ...
      r = function() {
        l || (o.ngModel = null, o.value = null),
        o.isLoadingLabel = !0,
        o.cluster && o.cluster.id && (a = e.cluster.listHostLabel(o.cluster.id).then(function(n) {
          var e = n || [];
      ...
      var m = function() {
        angular.isArray(o.ngModel) && (angular.equals(o.ngModel, o.value) || o.ngModel.length > 0 && a.then(function(n) { (o.ngModel || []).forEach(function(e) {
      ...
      var c = function() {
        if (o.hostEnv) {
          ...
          i = angular.copy(o.ngModel || []),
          i = i.filter(function(n) {
            return "HOSTENVTYPE" !== n.content
          }).concat(n[o.hostEnv])
        }
      };
      n.$watch("$ctrl.cluster", r),
      n.$watch("$ctrl.ngModel", m)
    }]
  }),
  n.component("imageTagSelector", {
    ...
    function(n, e, t) {
      ...
      i = function() {
        o.isLoadingImageTag = !0,
        o.image && o.image.name && o.image.registry && (l = e.image.privateRegistry.listImageTags(o.image.name, o.image.registry).then(function(n) {
      ...
      a = function() {
        angular.equals(o.ngModel, o.value) || o.ngModel && l.then(function() { (o.imageTagSelectorList || []).forEach(function(n) {
      ...
      n.$watch("$ctrl.image", i),
      n.$watch("$ctrl.ngModel", a)
    }]
  }),
  n.component("volumeMountStorage", {
    ...
    function(n, e, t) {
      ...
      o.showVolumeMountTable = function() {
        ...
        t.common({
          ...
          n === t.button.BUTTON_OK ? o.existentVolumeMountList.map(function(n) {
            ...
            }) && (n.copied = !1, o.ngModel.push(angular.copy(n)), i()),
            n.copied = !1,
            n
      ...
      var l = function() {
        o.existentVolumeMountList = [],
        (o.containerConsoles || []).forEach(function(n) { (n.volumeMountConsoles || []).forEach(function(n) {
      ...
      n.$watch("$ctrl.ngModel", l, !0),
      n.$watch("$ctrl.ngModel", i),
      n.$watch("$ctrl.containerConsoles.volumeMountConsoles", l, !0),
      n.$watch("$ctrl.name",
      function() {
        o.param.name = o.name
      })
  ...
  n.component("volumeMountConfigmap", {
    ...
    function(n, e, t) {
      ...
      var a = function() {
        angular.isArray(o.ngModel) && 0 !== o.ngModel.length && l.then(function() {
          o.ngModel.map(function(n) {
            n.configMapVolumeSelectorList = angular.copy(o.configMapSelectorList),
            n.configMapVolumeSelectorList.forEach(function(e) {
              if (n.name === e.text) return n.configMap = e.value,
              n.configMap.configFileList = n.volumeConfigMap.iterms ? Object.keys(n.volumeConfigMap.iterms).map(function(t) {
                return {
                  name: t,
                  content: e.value.data[t],
                  path: n.volumeConfigMap.iterms ? n.volumeConfigMap.iterms[t] : null
                }
              }) : e.value.configFileList,
              n
            })
          })
        })
      ...
      n.$watch("$ctrl.cluster", i),
      n.$watch("$ctrl.namespace", i),
      n.$watch("$ctrl.ngModel", a),
      n.$watch("$ctrl.name",
      function() {
        o.param.name = o.name
  ...
  n.component("formMultipleItemScroll", {
    ...
    function(n) {
      ...
      e.ngModel = 0,
      e.value = null,
      e.deleteOption = function(n) {
        e.options.splice(n, 1),
        n === e.ngModel || 0 === e.ngModel ? e.ngModel = 0 : e.ngModel = e.ngModel - 1
      };
      var t = function(n, t) {
      ...
      n.$watch("$ctrl.options.length", t, !0),
      n.$watch("$ctrl.options.length", o, !0)
    }]
  })
