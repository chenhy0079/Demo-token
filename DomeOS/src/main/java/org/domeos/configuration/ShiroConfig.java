...
import org.domeos.framework.shiro.authenticator.ModularAuthorizer;
...
import org.domeos.framework.shiro.realm.JwtRealm;
...
public class ShiroConfig {
    ...
    public DmoShiroFilterFactoryBean shiroFilter() {
        ...
        filters.put("authc", new JwtAuthcFilter());
...
//        filters.put("etag", new ShallowEtagHeaderFilter());
        ...
        chains.put("/restapi/**", "authc,user,backend");
    ...
    public DefaultWebSecurityManager securityManager() {
        ...
        manager.setAuthorizer(modularAuthorizer(realms));
        return manager;
    }
...
//            sessionManager.setSessionIdCookie(sessionCookie());
    ...
    @Bean
    public ModularAuthorizer modularAuthorizer(Collection<Realm> realms) {
    	ModularAuthorizer modularAuthorizer = new ModularAuthorizer();
    	modularAuthorizer.setRealms(realms);
        return modularAuthorizer;
    }
